...
const CTAButton = () => {
  ...
  return (
    ...
    >
      {/* Hover Background */}
      <span className="absolute inset-0 w-full h-full transition duration-300 ease-out opacity-0 bg-gradient-to-br from-[var(--blue-50)] via-blue-950 to-gray-900 group-hover:opacity-100 z-0"></span>
      ...
      {/* Button text */}
      <span className="relative z-20 text-xl text-[var(--white-50)] font-semibold hover:text-white">Get in Touch</span>
    </motion.button>
  );
};
