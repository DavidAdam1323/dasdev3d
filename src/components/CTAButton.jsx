...
const CTAButton = () => {
  ...
  return (
    <motion.button
      ...
      className="hidden lg:inline-flex relative items-center justify-center px-8 py-3 text-white font-semibold rounded-md shadow-2xl overflow-hidden group"
    >
      {/* Hover Background */}
      ...
      <span className="absolute inset-0 w-full h-full border border-white rounded-md opacity-10 z-10"></span>
